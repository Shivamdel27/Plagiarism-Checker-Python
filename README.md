...
[![Become a patron](pictures/become_a_patron_button.png)](https://www.patreon.com/ShivamSingh)
...
```bash
git clone https://github.com/Shivamdel27/Plagiarism-checker-Python
```
...
Would you like to use a Python library instead to help you compare strings and documents without spending time writing the vectorizers by yourself, then take a look at [Pysimilar](https://github.com/Shivamdel27/pysimilar).

## Explore it 

Explore it and twist it to your own use case. In case of any questions feel free to reach me directly at *ShivamSingh45978@gmail.com*.
...
All the credit goes to[Shivam Singh](https://github.com/Shivamdel27).
